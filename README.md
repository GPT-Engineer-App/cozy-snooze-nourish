...
**Project**: cozy-snooze-nourish 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: I baby sleep and food tracking app ith supabase connection 
...
```sh
git clone https://github.com/GPT-Engineer-App/cozy-snooze-nourish.git
cd cozy-snooze-nourish
npm i
